export const GOVERNANCE_ROOM_DATA = {
  id: "governance-and-regulations",
  ...
  tasks: [
    {
      id: 1,
      title: "Introduction",
      subtitle: "The Core of Governance & Compliance",
      icon: "book",
      difficulty: "Beginner",
      xp: 15,
      image: "/images/rooms/governance_intro.png",
      scenario: {
        title: "Establishing the Framework",
        text: "Governance and regulation form the foundation of any organization's cyber defense. Understanding how policies, laws, and compliance frameworks protect assets is the first step toward building a robust security posture.",
        impact: "Effective governance ensures that security practices align with business goals and legal mandates, preventing severe financial and reputational damage."
      },
      content: [
        ...
        { type: "image", src: "/images/rooms/governance_intro.png", alt: "Security Governance", maxWidth: "480px" },
        { type: "heading", value: "Learning Objectives" },
        { type: "list", items: [
        ...
        { type: "heading", value: "Prerequisite" },
        { type: "text", value: "A basic understanding of the following two rooms is suggested; however, not mandatory:\n\n* **Principles of Security**\n* **Web Application Security**\n\nWe are all set to start if you have already gone through the above rooms." }
      ],
      questions: [
        {
          id: "gov_q1",
          text: "Answer the questions below:\nI am ready to start the room.",
          answer: "I am ready to start the room.",
          acceptableAnswers: ["I am ready to start the room.", "ready", "yes", "I am ready to start the room"],
          hint: "Type 'I am ready to start the room.'"
        }
      ]
    },
    {
      ...
      subtitle: "Understanding GRC, processes, regulations, and laws",
      icon: "shield",
      difficulty: "Beginner",
      xp: 15,
      scenario: {
        title: "Defining Importance",
        text: "Implementing robust security policies is only half the battle. Comprehending why regulations exist and how they protect the business ensures effective integration and compliance.",
        impact: "Failing to comply with regulatory mandates leads to legal action, multi-million dollar penalties, and permanent loss of user trust."
      },
      content: [
        { type: "heading", value: "Important Terminologies" },
        { type: "list", items: [
        ...
        { type: "heading", value: "Information Security Governance" },
        { type: "text", value: "Information security governance represents an organisation's established structure, policies, methods, and guidelines designed to guarantee the privacy, reliability, and accessibility of its information assets. Given the escalating complexity of cyber threats, the significance of information security governance is continually growing. It is essential for risk management, safeguarding confidential data from unauthorised intrusion, and adhering to pertinent regulations. Information security governance falls under the purview of top-tier management and includes the following processes:" },
        {
          ...
          right: {
            type: "image",
            src: "/images/rooms/governance_processes.png",
            alt: "Information Security Governance Processes Pyramid",
            maxWidth: "320px"
          }
        },
        { type: "heading", value: "Information Security Regulation" },
        ...
        { type: "heading", value: "Key Benefits" },
        { type: "text", value: "The following are the benefits of implementing governance and regulation:" },
        {
          type: "row",
          left: {
            type: "list",
      ...
      questions: [
        {
          id: "gov_q2",
          text: "A rule or law enforced by a governing body to ensure compliance and protect against harm is called?",
          answer: "Regulation",
          acceptableAnswers: ["Regulation", "regulation", "Regulations", "regulations"],
          hint: "Check the 'Important Terminologies' section."
        },
        {
          id: "gov_q3",
          text: "Health Insurance Portability and Accountability Act (HIPAA) targets which domain for data protection?",
          answer: "Healthcare",
          acceptableAnswers: ["Healthcare", "healthcare", "health", "Health"],
          hint: "Check the table for the HIPAA law."
        }
      ]
    },
    {
      ...
      subtitle: "Understanding Policies, Standards, Guidelines, Procedures, and Baselines",
      icon: "file-text",
      difficulty: "Beginner",
      xp: 15,
      scenario: {
        title: "Establishing Frameworks",
        text: "Policies, standards, and baselines establish clear expectations for organizational behavior and technical settings. Without these documents, compliance is impossible to measure.",
        impact: "A lack of standardized security frameworks results in fragmented security practices, leaving critical systems vulnerable and compliance audits failing."
      },
      content: [
        { type: "heading", value: "Information Security Frameworks" },
        { type: "text", value: "The information security framework provides a comprehensive set of documents that outline the organisation's approach to information security and governs how security is implemented, managed, and enforced within the organisation. This mainly includes:" },
        { type: "list", items: [
        ...
        { type: "heading", value: "Developing Governance Documents" },
        { type: "text", value: "Here are some generalised steps used to develop policies, standards, guidelines, etc." },
        {
          type: "row",
          left: {
            type: "list",
          ...
          right: {
            type: "image",
            src: "/images/rooms/governance_frameworks_steps.png",
            alt: "Developing Governance Documents Steps",
            maxWidth: "350px"
          }
        },
        { type: "heading", value: "Explanation through Real-world Scenarios" },
        { type: "text", value: "We will go through some real-world scenarios to fully understand the steps to develop these documents." },
        { type: "heading", value: "Preparing a Password Policy" },
        { type: "list", items: [
        ...
        { type: "heading", value: "Making an Incident Response Procedure" },
        { type: "list", items: [
          ...
          "**Report the incident**: Report the incident to management and document the incident response process for future reference.",
          "**Communicate**: Communicate the incident response procedures.",
          "**Review and update**: Review and update the incident response procedures."
        ] },
      ...
      questions: [
        {
          id: "gov_q4",
          text: "The step that involves monitoring compliance and adjust the document based on feedback and changes in the threat landscape or regulatory environment is called?",
          answer: "Review and update",
          acceptableAnswers: ["Review and update", "review and update", "Review & update", "review & update"],
          hint: "Check the 6th step in the Developing Governance Documents diagram/list."
        },
        {
          id: "gov_q5",
          text: "A set of specific steps for undertaking a particular task or process is called?",
          answer: "Procedures",
          acceptableAnswers: ["Procedures", "procedures", "Procedure", "procedure"],
          hint: "Check the list of Important Terminologies under Information Security Frameworks."
        }
      ]
    },
    {
      ...
      subtitle: "The Three Pillars of Security Management",
      icon: "shield-alert",
      difficulty: "Beginner",
      xp: 15,
      scenario: {
        title: "The GRC Framework",
        text: "GRC brings governance, risk, and compliance together under a single, unified strategy. This ensures that every security control has a clear purpose and standard.",
        impact: "Failing to integrate GRC leads to siloed operations, where security teams implement controls that do not align with compliance or overall business goals."
      },
      content: [
        ...
        { type: "heading", value: "Components of GRC" },
        {
          type: "row",
          left: {
            type: "list",
          ...
          right: {
            type: "image",
            src: "/images/rooms/governance_grc_circles.png",
            alt: "GRC Components: Governance, Risk Management, Compliance",
            maxWidth: "350px"
          }
        },
        { type: "heading", value: "How to Develop GRC Program - Generic Guidelines" },
        ...
        { type: "heading", value: "An Example - GRC Framework in Financial Sector" },
        { type: "text", value: "To fully understand each component of GRC, it is necessary to understand it with real-world examples and scenarios. In the ensuing section, we will see how the financial industry implements each component of the GRC framework:" },
        { type: "list", items: [
      ...
      questions: [
        {
          id: "gov_q6",
          text: "What is the component in the GRC framework involved in identifying, assessing, and prioritising risks to the organisation?",
          answer: "Risk Management",
          acceptableAnswers: ["Risk Management", "risk management", "Risk management", "risk Management"],
          hint: "Check the 'Components of GRC' section."
        },
        {
          id: "gov_q7",
          text: "Is it important to monitor and measure the performance of a developed policy? (yea/nay)",
          answer: "yea",
          acceptableAnswers: ["yea", "Yea", "yes", "Yes", "y", "Y"],
          hint: "Check step 6 under the Generic Guidelines: Monitor and measure performance."
        }
      ]
    },
    {
      ...
      subtitle: "Securing Personally Identifiable Information (PII)",
      icon: "lock",
      difficulty: "Beginner",
      xp: 20,
      scenario: {
        title: "PII and Regulations",
        text: "Privacy regulations protect Personally Identifiable Information (PII) from unauthorized usage. Storing or handling PII requires compliance with GDPR, PCI DSS, and other standards.",
        impact: "Improper handling of PII leads to severe regulatory penalties, lawsuits, and complete destruction of brand integrity."
      },
      content: [
        ...
        { type: "heading", value: "General Data Protection Regulation (GDPR)" },
        { type: "text", value: "The GDPR is a data protection law implemented by the EU in May 2018 to protect personal data. Personal data is \"Any data associated with an individual that can be utilised to identify them either directly or indirectly\". Key points of the law include the following:" },
        { type: "list", items: [
        ...
        { type: "image", src: "/images/rooms/governance_gdpr_benefits.png", alt: "What are the benefits of GDPR", maxWidth: "650px" },
        ...
        { type: "heading", value: "Payment Card Industry Data Security Standard (PCI DSS)" },
        { type: "text", value: "PCI DSS is focused on maintaining secure card transactions and protecting against data theft and fraud. It is widely used by businesses, primarily online, for card-based transactions. It was established by major credit card brands (Visa, MasterCard & American Express). It requires strict control access to cardholder information and monitoring unauthorised access, using recommended measures such as web application firewalls and encryption. You can learn more about the standard [here](https://www.pcisecuritystandards.org/)." }
      ],
      questions: [
        {
          id: "gov_q8",
          text: "What is the maximum fine for Tier 1 users as per GDPR (in terms of percentage)?",
          answer: "4%",
          acceptableAnswers: ["4%", "4 percent", "4"],
          hint: "Check the GDPR non-compliance Tier 1 penalty details in the text."
        },
        {
          id: "gov_q9",
          text: "In terms of PCI DSS, what does CHD stand for?",
          answer: "Cardholder Data",
          acceptableAnswers: ["Cardholder Data", "cardholder data", "Card Holder Data", "card holder data"],
          hint: "Think about the data stored on credit cards that PCI DSS aims to protect."
        }
      ]
    },
    {
      id: 6,
      title: "Information Security Management and Compliance",
      subtitle: "ISO 27001 and SOC 2 Audits",
      icon: "clipboard-list",
      difficulty: "Beginner",
      xp: 20,
      scenario: {
        title: "Compliance Audits",
        text: "Implementing robust security controls is only verified through independent audits. Standards like ISO 27001 and SOC 2 provide standard frameworks to evaluate security postures.",
        impact: "Failing compliance audits prevents organizations from conducting business with enterprise clients, resulting in catastrophic loss of potential revenue."
      },
      content: [
        ...
        { type: "heading", value: "ISO/IEC 27001" },
        { type: "text", value: "ISO 27001 is an internationally recognised standard for requirements to plan, develop, run, and update an organisation's Information Security Management System (ISMS). The official ISO/IEC 27001 documents are paid for and can be purchased. It was developed by International Organization for Standardization (ISO) and the International Electrotechnical Commission (IEC) and has the following core components:" },
        { type: "list", items: [
        ...
        { type: "image", src: "/images/rooms/governance_iso27001_benefits.png", alt: "What are the benefits of ISO 27001", maxWidth: "650px" },
        ...
        { type: "heading", value: "Service Organisation Control 2 (SOC 2)" },
        ...
        { type: "heading", value: "Important Cardinals" },
        { type: "list", items: [
        ...
        { type: "heading", value: "What Information Security Protection SOC 2 provides?" },
        { type: "text", value: "The primary purpose of the SOC 2 audit is to ensure that third-party service providers store and process sensitive information securely." },
        { type: "heading", value: "Planning and Undergoing a SOC 2 Audit" },
        { type: "text", value: "The following steps can be taken by an organisation’s management team before and during an audit:" },
        { type: "list", items: [
        ...
        { type: "heading", value: "What are the generic controls that will be checked during SOC 2 audit" },
        { type: "image", src: "/images/rooms/governance_soc2_controls.png", alt: "SOC 2 Generic Controls Diagram", maxWidth: "600px" },
        { type: "text", value: "The above diagram shows the generic controls that will be checked during a SOC 2 audit for a financial company depending on the scope of the audit. Other than that, there are technical and specific controls, like ensuring data encryption in transit, network security, incident management, etc." }
      ],
      questions: [
        {
          id: "gov_q10",
          text: "Which ISO/IEC 27001 component involves selecting and implementing controls to reduce the identified risks to an acceptable level?",
          answer: "Risk treatment",
          acceptableAnswers: ["Risk treatment", "risk treatment", "Risk Treatment", "risk Treatment", "Treatment", "treatment"],
          hint: "Check the core components list under ISO/IEC 27001."
        },
        {
          id: "gov_q11",
          text: "In SOC 2 generic controls, which control shows that the system remains available?",
          answer: "Availability",
          acceptableAnswers: ["Availability", "availability"],
          hint: "Check the SOC 2 star diagram for the Availability lobe."
        }
      ]
    }
  ]
...
export const GOVERNANCE_BADGES = [
  { id: "gov-intro", icon: "📚", name: "GRC Initiate", desc: "Start the Governance & Regulations room" },
  { id: "gov-compliance", icon: "⚖️", name: "Compliance Officer", desc: "Complete all governance tasks" }
];

export const GOVERNANCE_QUIZ = [
  {
    id: "gov_fq1",
    question: "Which component of GRC focuses on steering the organization's direction by preparing policies, standards, and setting security strategies?",
    options: ["Compliance", "Risk Management", "Governance", "Auditing"],
    correctAnswer: "Governance",
    explanation: "Governance involves guiding an organisation by setting its direction through information security strategy, policies, standards, and baselines."
  },
  {
    id: "gov_fq2",
    question: "Which document in ISO/IEC 27001 defines which security controls from the standard are applicable and which are not?",
    options: ["Statement of Applicability (SoA)", "Information Security Policy", "Internal Audit Report", "Risk Treatment Plan"],
    correctAnswer: "Statement of Applicability (SoA)",
    explanation: "The Statement of Applicability (SoA) explicitly identifies which security controls from Annex A of ISO 27001 are applicable to the organization's scope and provides justifications for exclusions."
  },
  {
    id: "gov_fq3",
    question: "Under GDPR, sharing customer data with third parties without their explicit consent falls under which category of violation and maximum fine?",
    options: [
      "Tier 1: Up to 4% of global annual turnover",
      "Tier 2: Up to 2% of global annual turnover",
      "Tier 1: Up to 10 million euros",
      "Tier 2: Up to 20 million euros"
    ],
    correctAnswer: "Tier 1: Up to 4% of global annual turnover",
    explanation: "Sharing personal data without consent is a more severe violation, classified under Tier 1, which carries a maximum fine of 4% of global annual turnover or 20 million euros (whichever is higher)."
  },
  {
    id: "gov_fq4",
    question: "Which standard is specifically established by major credit card brands to secure transaction processing and prevent cardholder data theft?",
    options: ["ISO 27001", "PCI DSS", "SOC 2", "GLBA"],
    correctAnswer: "PCI DSS",
    explanation: "PCI DSS (Payment Card Industry Data Security Standard) was formed by major credit card brands (Visa, Mastercard, AMEX) to protect credit/debit card transactions from fraud and theft."
  },
  {
    id: "gov_fq5",
    question: "Which organization developed the SOC 2 compliance framework to reassure stakeholders about data security controls?",
    options: ["ISO (International Organization for Standardization)", "AICPA (American Institute of Certified Public Accountants)", "EU Parliament", "NIST (National Institute of Standards and Technology)"],
    correctAnswer: "AICPA (American Institute of Certified Public Accountants)",
    explanation: "SOC 2 was developed by the AICPA (American Institute of Certified Public Accountants) to audit service organizations on security, availability, processing integrity, confidentiality, and privacy."
  }
];
