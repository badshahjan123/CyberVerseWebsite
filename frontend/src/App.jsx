...
const SecureAdminDashboard = lazy(
  () => import("./pages/admin/SecureAdminDashboard"),
);
const AdminUserDetail = lazy(() => import("./pages/admin/AdminUserDetail"));
const RoomEditor = lazy(() => import("./pages/admin/RoomEditor"));
const SimpleUserManagement = lazy(
  () => import("./pages/admin/SimpleUserManagement"),
);
...
const DynamicRoom = lazy(() => import("./pages/rooms/DynamicRoom"));
...
function AppContent() {
  ...
  const isAdminRoute =
    location.pathname.startsWith("/secure-admin") ||
        ...
        <Suspense fallback={<PageLoader />}>
          {isAdminRoute ? (
            ...
            <Routes>
              ...
              <Route path="/rooms/:id" element={<DynamicRoom />} />
